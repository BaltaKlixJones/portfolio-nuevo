...
const About = () => {
  return (
    <section id="about" class="about" style={{marginBottom:"100px"}}>
        ...
        <div class="row content">
          <div class="col-lg-6">
            ...
            <ul>
              ...
              <li>
                <i class="ri-check-double-line"></i> Estoy emocionado de aplicar
                mis habilidades y experiencia para ayudar a mis clientes a
                alcanzar sus objetivos y superar sus desafíos.
              </li>
              <li>
                <i class="ri-check-double-line"></i> ¡Gracias por tomarse el
